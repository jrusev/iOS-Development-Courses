...
/* This method returns an array that has four arrays of tile objects. For tile objects we setup initial properties so that we can properly update our views */
-(NSArray *)tiles
{
    ...
    /* Notice that we use a custom initializer, initWithObjects, to create an NSArray object with 4 objects.  These four objects are our 4 arrays that contain the tile objects */
    NSArray *tiles = [[NSArray alloc] initWithObjects:firstColumn, secondColumn, thirdColumn, fourthColumn, nil];
    
    return tiles;
}

/*This method returns a character object. Notice that we have to create both an instance of our armor class as well as our weapon class and then set the character's weapon and armor property to these objects */
...
/*This method returns a boss object with an initial health stat of 65. */
-(CCBoss *)boss
{
